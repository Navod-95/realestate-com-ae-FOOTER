    ...
    <>
      <header
        className={`header left-0 top-0 z-40 flex w-full items-center ${
          sticky
            ? "fixed z-[9999] bg-white !bg-opacity-80 shadow-sticky backdrop-blur-sm transition dark:bg-custom-green dark:shadow-sticky-dark"
            ...
            <div className="w-auto max-w-full px-4 xl:mr-12">
              ...
              >
                <Image
                  ...
                  className="h-auto w-auto max-w-[200px] dark:hidden md:max-w-[250px] lg:max-w-[300px]"
                />
                <Image
                  ...
                  width={200}
                  height={50}
                  className="hidden h-auto w-auto max-w-[200px] dark:block md:max-w-[250px] lg:max-w-[300px]"
                />
              </Link>
            </div>
      ...
      {menuItem.path ? (
        ...
        <>
          <p
            ...
            className="flex cursor-pointer items-center justify-between py-6 text-sm text-dark group-hover:text-primary dark:text-white/70 dark:group-hover:text-white lg:mr-0 lg:inline-flex lg:px-0 lg:py-6"
            >
            {menuItem.title}
            <span className="pl-3">
